...
class BotsPage extends Component {
  ...
  render() {
    return (
      <div>
        <YourBotArmy bots={this.state.armyBots} addBot={this.removeBotFromArmy} removeBot={this.removeBot}/>
        <BotCollection bots={this.state.bots} addBot={this.toggleBotToArmy} removeBot={this.removeBot} />
      </div>
    );
  }
}
